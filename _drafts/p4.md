...
Unlike Git, Perforce has no idea what has changed, only that these files are different than the serer's files.
...
Perforce is now aware of these changes and all other changes to come, until I submit or revert a files changes.


### Diffs, Changes, and Submissions ###
